---
title: 'Two kinds of marketing companies: one sells a package, one builds a marketing system'
seoTitle: 'Marketing Systems vs Packages: Which Are You Buying?'
description: 'One company sells you a package, one builds you a marketing system. The difference line by line, plus a game that translates any offer before you sign.'
...
First: [my packages](/services/#packs) are combinations of services that complete each other (strategy, identity, website...), not a monthly count of pieces. You can read each one in full: [The Right Start](/services/packages/launch/), [Monthly Growth](/services/packages/growth/), and [The Full System](/services/packages/system/). And the price comes out of diagnosing your project, not out of a fixed menu.
