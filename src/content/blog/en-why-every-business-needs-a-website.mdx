...
seoTitle: 'Running a Business Without a Website? Read This First'
description: 'A business without a website is built on rented land, and AI just raised the stakes. Count what you lose monthly, then calculate it with the loss tool.'
date: 2026-07-27
lang: 'en'
...
If you are running a business on social only and are not sure whether now is the right time, [tell me about it](/#contact) and we will do the maths together: what it costs, what it returns, and where it makes sense to start. And when you are ready to build, this is what my [web design in Jordan](/services/websites/) work looks like.
