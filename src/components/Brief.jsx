...
const COPY = {
  ar: {
    ...
    errSend: 'الطلب ما انبعت. جرّب كمان مرة، أو انسخ الطلب من الزر تحت وابعتهولي واتساب.',
    sending: 'عم نبعت…',
    // ─── بعد الإرسال ───
    ...
    doneBody:
      'بقراه أنا شخصياً. مش نموذج آلي. برجعلك خلال ٢٤ ساعة، وغالباً أسرع. وإذا استعجلت، احكيني واتساب مباشرة.',
