...
export default function BudgetGame({
  ...
  // ═══════════════════════════════════════════════════════════
  //  ⚠️ ملاحظة مهمة: لا تضيف lenis.stop() هون
  //
  //  كانت أول نسخة بتوقّف السكرول الناعم عند لمس منطقة السلايدرات
  //  وبترجّعه عند رفع الإصبع. وطلع فيها مشكلتين خطيرتين:
  //
  //  1) lenis.stop() بتحط overflow:hidden على الصفحة كلها. فأي
  //     لمسة بمنطقة السلايدرات كانت بتقفل سكرول الموقع كامل،
  //     يعني ما بتقدر تمرّر بالقسم أصلاً.
  //  2) لو رفعت إصبعك برّا المنطقة (وهاد بيصير كتير وأنت بتسحب)،
  //     حدث الرفع ما بيوصل — والصفحة بتضل مقفلة!
  //
  //  الحل الصح: touch-action: pan-y على السلايدر بملف budget.css
  //  المتصفح بيفهم لحاله: سحب عمودي = تمرير الصفحة،
  //  سحب أفقي = تحريك السلايدر. بدون ما نلمس Lenis إطلاقاً.
  //
  //  وهون بنتأكد إنه السكرول شغال، تحسّباً لأي إشي قفله قبلنا.
  // ═══════════════════════════════════════════════════════════
  useEffect(() => {
