  ...
  },
  {
    ...
    ar: {
      ...
      fixes: [
        ...
        { text: 'قوالب رد جاهزة للأسئلة المتكررة + وقت رد أقصاه ساعة بأوقات الدوام', keep: 0.6, why: 'الإصلاح الصح: نص البيع عنا بيصير بالمسجات، والحرارة بتبرد بسرعة. أغلب الأسئلة متكررة أصلاً، فالقوالب بتخلي الرد سريع وكامل مش سريع وناقص.' },
