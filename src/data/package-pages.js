...
export const PACKS = {
  launch: {
    ar: {
      ...
      seoDesc: 'البكج اللي بيبني الأساس بالترتيب الصح: نفهم السوق، نبني الهوية، ونطلّع موقع بيبيع. لمشروع جديد أو مشروع حاسس إنه مش مترتب.',
      story: 'أغلب المشاريع بتبلش من الآخر: إعلان ممول على هوية مش جاهزة وموقع مش موجود. النتيجة معروفة: كبسات بتروح عالفاضي، وميزانية بتنحرق مرتين — مرة عالإعلان ومرة على إعادة بناء اللي انبنى غلط. هاد البكج بيمشي بالترتيب الطبيعي: منفهم أول، منبني الهوية ثاني، ومنطلّع الموقع ثالث. بالآخر بيكون عندك أساس كل اللي بعده بينبني عليه.',
      whyEach: {
      ...
      notFit: ['بدك إعلانات هالأسبوع ونتائج بكرة — هاد بكج أساس مش بكج سرعة', 'أساسك جاهز فعلاً (هوية وموقع منيحين) — وقتها النمو الشهري أنسبلك'],
      faq: [
  ...
  growth: {
    ar: {
      ...
      story: 'المشكلة بالشغل الشهري المعتاد إنه قطع متفرقة: حدا بيصمم، حدا بيبوّست، وحدا «بيعمل بوست» — وكل واحد بوادي. هاد البكج بيشغّل الثلاثة بإيقاع واحد: المحتوى بيبني الثقة، الفيديو بيمسك الانتباه، والإعلان بياخد أحسن اللي اشتغل وبيوصله لناس جداد. وكل شهر بيسكّر بأرقام بتقرر شو منعمل الشهر الجاي — مش بتقرير لايكات.',
      whyEach: {
      ...
      faq: [
        ...
        { q: 'مين بيرد عالرسائل والتعليقات؟', a: 'بنتفق بالتشخيص: في مشاريع بتحب تمسك صوتها بنفسها وإحنا منجهزلها القوالب، وفي مشاريع منديرلها التفاعل كامل. الثنتين بيشتغلوا — المهم يكون قرار مش صدفة.' },
  ...
  system: {
    ar: {
      ...
      seoDesc: 'الدورة كاملة بتتكرر كل شهر: تشخيص، تنفيذ، قياس، وتحسين — استراتيجية وسيو وإعلانات وسوشال بمنظومة وحدة.',
      story: 'في فرق بين حدا بينفذلك مهام وحدا شريك بنمو مشروعك. المنظومة الكاملة هي الخيار الثاني: مش «شو بدك نعمل هالشهر؟» — إحنا منيجي عالطاولة بأرقام وتوصيات: هاد اشتغل ومنزيده، هاد بيخسر ومنوقفه، وهاي فرصة ما حدا شايفها. الدورة بتلف كل شهر: تشخيص، تنفيذ، قياس، تحسين — وكل لفة بتبني على اللي قبلها.',
      whyEach: {
        strategy: 'العقل المدبّر: كل قرار شهري بيرجع لسؤال «هل هاد بيقربنا من الهدف؟» مش لمزاج اللحظة.',
        seo: 'الاستثمار طويل النفس: بينما الإعلان بيجيب زباين اليوم، السيو بيبني ظهورك اللي بيجيب زباين السنة الجاية ببلاش.',
      ...
      faq: [
        { q: 'شو الفرق عن النمو الشهري؟', a: 'النمو الشهري تنفيذ بإيقاع. المنظومة بتضيف الطبقة اللي فوقه: استراتيجية بتوجه، سيو بيبني للبعيد، وقياس بيقرر — يعني شريك بيفكر بمشروعك مش بس بينفذ.' },
        { q: 'كيف بتابع شو عم بيصير؟', a: 'أرقامك بتوصلك بإيقاع ثابت وبلغة مفهومة، ومكالمة شهرية منقرا فيها الدورة كاملة: شو صار، ليش، وشو الجاي. وأنت بتقرر معنا، مش بتتفرج.' },
