...
export const PACKS = {
  launch: {
    ar: {
      seoTitle: 'بكج البداية الصح: استراتيجية وهوية بصرية وموقع الكتروني',
      seoDesc: 'باقة تسويق الكتروني للي لسا ببداية الطريق: بفهم السوق، ببني الهوية، وبطلّع موقع بيبيع. لمشروع جديد أو مشروع حاسس إنه مش مترتب. احكيلي.',
  ...
  growth: {
    ar: {
      seoTitle: 'بكج النمو الشهري: سوشيال ميديا وفيديو وإعلانات ممولة',
      seoDesc: 'باقة شهرية بإيقاع واحد: إدارة سوشيال ميديا بمحتوى بيبني ثقة، فيديو بيوقّف الإصبع، وإعلانات ممولة بتوسّع الوصول. قياس واحد وقرارات بالأرقام.',
  ...
  system: {
    ar: {
      seoTitle: 'بكج المنظومة الكاملة | باقة تسويق الكتروني متكاملة',
      seoDesc: 'باقة تسويق الكتروني متكاملة بتتكرر كل شهر: تشخيص، تنفيذ، قياس، وتحسين. استراتيجية وSEO وإعلانات وسوشيال ميديا بمنظومة وحدة. احكيلي.',
