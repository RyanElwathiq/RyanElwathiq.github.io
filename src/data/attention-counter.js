...
export const ROUNDS = [
  {
    ...
    ar: {
      ...
      options: [
        ...
        { text: 'بتطلب أكل وبيوصلك بارد؟ عنا توصيل خلال ٢٠ دقيقة أو الطلب علينا.', keep: 0.55, tag: 'مشكلة العميل', why: 'حكيت عن وجع بيعرفه (الأكل البارد) وربطته بوعد محدد قابل للمساءلة. هيك بيوقف الزائر.' },
      ],
    },
    en: {
