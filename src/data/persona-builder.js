  ...
  },
  {
    ...
    en: {
      ...
      options: [
        ...
        { text: 'Nothing yet, afraid to try', frag: 'have not tried anything serious yet, afraid of burning money for nothing' },
      ],
    },
  },
  {
...
export const TEXTS = {
  ar: {
    ...
    note: 'هاي بيرسونا من خيارات جاهزة للتوضيح. البيرسونا الحقيقية لمشروعك بتنبني من محادثات زباينك الفعليين، ومن أسئلتهم بالمسجات، ومن سبب آخر ثلاث مبيعات صارت.',
  },
  en: {
