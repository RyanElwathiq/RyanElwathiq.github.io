    ...
    ctx.waitUntil(
      (async () => {
        ...
        if (cron === '0 5 * * *') {
          ...
          if (isFriday) {
            ...
            await tgSend(
              env,
              '🎯 <b>٩:٠٠ — بلوك الصيد</b>\n\n' +
                '١٠ رسائل من <code>Outreach/ملف-السبت.md</code>\n\n' +
                '⚠️ القاعدة: بحث كامل قبل أي رسالة. ولا رسالة قبل ما الثمانية يجاوبوا.\n' +
                '⚠️ ولا رسالة لنشاط بقائمة التحقّق قبل ما نتأكد.',
            );
          }
          return;
        }
        ...
        if (cron === '0 10 * * *') {
          await tgSend(
            env,
            '📱 <b>١٣:٠٠ — بلوك المحتوى</b>\n\n' +
              'بوست اليوم + <b>١٠ تعليقات ذكية</b> على بوستات أصحاب مشاريع\n\n' +
              'الكوبي والكابشن جاهزين بالدرايف:\n' +
              '<code>٥ — الكوبي والكابشنات.md</code>\n\n' +
              '⚠️ كل بوست ثنائي اللغة. المهني إنجليزي فوق، والموجّه لأصحاب المشاريع عربي فوق.',
          );
          return;
        }
