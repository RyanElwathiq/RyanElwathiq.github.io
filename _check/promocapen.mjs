// تصوير الموقع الحي للفيلم الإنجليزي (2026-08-05) — نفس promocap.mjs
// بس على الصفحات الإنجليزية: /loss/ و /agent/
// المخرجات: Promo/capture-en/cap-loss.webm و cap-agent.webm
import { chromium } from '@playwright/test';
import { mkdirSync, renameSync, readdirSync, rmSync } from 'fs';

const OUT = 'D:/Ryan-Work/Brand-Ryan/Promo/capture-en';
...
await record('cap-loss', async (page) => {
  await page.goto('https://ryanalali.me/loss/', { waitUntil: 'load' });
...
await record('cap-agent', async (page) => {
  await page.goto('https://ryanalali.me/agent/', { waitUntil: 'load' });
