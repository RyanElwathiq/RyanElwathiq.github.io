// غلافا فيديو الوكلاء (عربي + إنجليزي) — نفس نمط lpcovers2 الموقعي
...
const COVERS = [
  ['lp-ai-agents-cover', site169(true, 'في موظف ما بينام، وما بينسى.', 'اسمه: وكيل ذكاء اصطناعي.')],
  ['lp-ai-agents-en-cover', site169(false, "There's an employee who never sleeps.", "It's called an AI agent.")],
];
