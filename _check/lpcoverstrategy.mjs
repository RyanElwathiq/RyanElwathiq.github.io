// غلافا فيديو الاستراتيجية (عربي + إنجليزي) — نفس نمط lpcoveragents
...
const COVERS = [
  ['lp-strategy-cover', site169(true, 'المشكلة مش بالتنفيذ.', 'المشكلة: ما في خطة.')],
  ['lp-strategy-en-cover', site169(false, "The problem isn't the execution.", "The problem: there's no plan.")],
];
