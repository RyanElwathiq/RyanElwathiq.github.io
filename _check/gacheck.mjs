...
page.on('request', (r) => {
  ...
  if (u.includes('clarity.ms')) clarityLoads.push(u);
...
if (!isLive) {
  ...
  check(clarityLoads.length === 0, `سكربت Clarity ما اتحمّل محلياً (${clarityLoads.length})`);
  ...
  check(clarityLoads.length > 0, 'سكربت Clarity اتحمّل');
