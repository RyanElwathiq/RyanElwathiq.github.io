// غلافا فيلم الأرقام (عربي + إنجليزي) — نفس النمط الموقعي
...
const COVERS = [
  ['lp-numbers-cover', site169(true, 'قبل ما نحكي عن التسويق…', 'خلينا نحكي أرقام.')],
  ['lp-numbers-en-cover', site169(false, 'Before we talk about marketing…', "let's talk numbers.")],
];
