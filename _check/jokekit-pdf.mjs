...
const SRC = {
  ...
  'caught-v-ar.mp4': `${FILM}/caught-v-ar.mp4`,
  // احتياطي: الريلز الإنجليزي العمودي — مش مجدول، بس موجود لو لزم
  'caught-v-EN (احتياطي).mp4': `${FILM}/caught-v.mp4`,
...
<div class="cover">
  ...
  <div class="rule">
    <b>العربي لإنستغرام والإنجليزي للينكدإن.</b><br>
    جمهورك على إنستغرام أردني بغالبيته، فالريلز العربي أنسب من الإنجليزي.
    ولينكدإن هو اللي بيفتحه مسؤولو التوظيف والعملاء الأجانب، فالنسخة الإنجليزية إلهم.
    <b>الريلز الإنجليزي العمودي موجود بالمجلد كاحتياطي</b> ومش مجدول.
  </div>

  <div class="rule">
    <b>النسخة العربية ٤٦ ثانية والإنجليزية ٤٠.</b><br>
    الفرق ست ثواني كلها بالآخر: البنش لاين صار يمسك ٣ ثواني بدل ١.٤،
    والختام ٣.٦ ثانية بدل ما كان يتلاشى فوراً. الإنجليزي انترك على حاله عن قصد
    لأنه انرندر ونزل قبل التعديل.
  </div>
